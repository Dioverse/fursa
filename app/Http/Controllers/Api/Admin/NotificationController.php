...
class NotificationController extends Controller
{
    ...
    {
        $templates = NotificationTemplate::orderBy('name')->get(['act', 'name', 'subject', 'email_body', 'shortcodes', 'loop_data', 'email_status', 'email_sent_from_name', 'email_sent_from_address']);
    ...
    // ✅ ONLY EMAIL TEMPLATE UPDATE ACTIVE
